...
export default function Dashboard() {
  ...
  const [wallet, setWallet] = React.useState(JSON.parse(localStorage.getItem("13x54r_keyPair")))
  ...
  const handleTransactionSend = () => {
    const privateKey = JSON.parse(localStorage.getItem("13x54r_keyPair")).privateKey;
